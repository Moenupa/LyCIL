...
class ResNet(nn.Module):
    ...
    def set_branches_mode(self, branch_mode: str | None = None) -> None:
        for module in self.modules():
            if hasattr(module, "branch_mode"):
                module.branch_mode = branch_mode

    def reset_branches_params(self) -> None:
        for module in self.modules():
            if hasattr(module, "reset_branch_params"):
                module.reset_branch_params()
