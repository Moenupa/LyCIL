...
from lightning_cil.methods.bic import BiC
...
class CLI(cli.LightningCLI):
    ...
    def run(self):
        ...
        for task_id in range(num_tasks):
            ...
            # Update memory and fit bias correction layer on a held-out exemplar split
...
if __name__ == "__main__":
    CLI(BiC, CIFAR100DataModule, save_config_callback=None, run=True)
